...
public class PieChartPanel extends JPanel {
    ...
    public PieChartPanel() {
        ...
        colorPalette = List.of(
                UITheme.ACCENT_BLUE_GRAY,
                UITheme.ACCENT_MAROON,
                new Color(0x373F4E),
                new Color(0x667085),
                UITheme.TEXT_LIGHT_GRAY.darker()
        );
        setBackground(UITheme.PRIMARY_NAVY); // Use panel color for background
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        int x = (width / 2) - diameter; // Position chart on the left
