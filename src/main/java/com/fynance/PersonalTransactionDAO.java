...
public class PersonalTransactionDAO {
    ...
    public void addTransaction(PersonalTransaction transaction) {
        String sql = "INSERT INTO personal_transactions (user_id, type, amount, category_id, transaction_date, notes) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void updateTransaction(PersonalTransaction transaction) {
        String sql = "UPDATE personal_transactions SET type = ?, amount = ?, category_id = ?, notes = ? WHERE transaction_id = ?";
    ...
    public void deleteTransaction(int transactionId) {
        String sql = "DELETE FROM personal_transactions WHERE transaction_id = ?";
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement pstmt = conn.prepareStatement(sql)) {
